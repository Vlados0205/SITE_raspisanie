<?php
    ...
    $query1 = mysqli_query($db, "SELECT * FROM class_pso_2021_2 WHERE `Day of week` = 'Понедельник'");
	$query2 = mysqli_query($db, "SELECT * FROM class_pso_2021_2 WHERE `Day of week` = 'Вторник'");
	$query3 = mysqli_query($db, "SELECT * FROM class_pso_2021_2 WHERE `Day of week` = 'Среда'");
	$query4 = mysqli_query($db, "SELECT * FROM class_pso_2021_2 WHERE `Day of week` = 'Четверг'");
	$query5 = mysqli_query($db, "SELECT * FROM class_pso_2021_2 WHERE `Day of week` = 'Пятница'");
